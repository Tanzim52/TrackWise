...
import { FaChartLine, FaBrain, FaMoneyBillWave, FaTasks, FaUserShield, FaCalendarCheck, FaClock, FaMobileAlt } from "react-icons/fa";
...
const features = [
  ...
  { icon: <FaClock />, title: "Time Management", desc: "Schedule your day efficiently with our intuitive planner." },
...
const TrackWiseFeatures = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-[#4c1a36] to-[#395c6b] text-white py-16 px-8 md:px-20">
      <motion.h2
